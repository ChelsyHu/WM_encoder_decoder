...
os.environ['GLOBAL_RANK']='0'
os.environ['n_gpu_per_node']='3'
...
def get_parser():
    ...
    aa("--lambda_w", type=float, default=0.0, help="Weight of the watermark loss. (Default: 1.0)")
    aa("--lambda_i", type=float, default=0.1, help="Weight of the image loss. (Default: 0.0)")
...
def main(params):
    ...
    if params.dist: 
        ...
        encoder_decoder = nn.parallel.DistributedDataParallel(encoder_decoder, device_ids=None) # device_ids=[params.local_rank]
