...
class HiddenDecoder(nn.Module):
    ...
    def forward(self, img_w):
        ...
        x = self.layers(img_w) # b c h w -> b d 1 1
...
class EncoderDecoder(nn.Module):
    ...
    def forward(
        ...
        #imgs_generation = img2img(imgs).to(self.device)   
        # print(imgs_generation.shape)  ## 16 3 256 256 
        
        imgs_w_generation = img2img(imgs_w).to(self.device)   # b c h w -> b c h w 
        # print(imgs_w_generation.shape)   ## 16 3 256 256 
