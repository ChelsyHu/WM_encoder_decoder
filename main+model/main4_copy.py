...
def main(params):
    ...
    optim_params = utils.parse_params(params.optimizer)  ## 字典类型 {‘name’:"Lamb",'lr':2e-2}
    lr_mult = params.batch_size * utils.get_world_size() / 512.0 *32
    ...
    ## CosineLRScheduler,lr_min=1e-5,t_initial=300,warmup_lr_init=1e-4,warmup_t=5
