...
# os.environ['LOCAL_RANK']='0'  这三行不能加上去。
...
def get_parser():
    ...
    aa("--lambda_w", type=float, default=0.01, help="Weight of the watermark loss. (Default: 1.0)")
    aa("--lambda_i", type=float, default=0.01, help="Weight of the image loss. (Default: 0.0)")
    aa("--lambda_latents_b", type=float, default=1.0, help="Weight of the image loss. (Default: 0.0)")
...
def main(params):
    ...
    if params.dist:
        ...
        # vae = nn.parallel.DistributedDataParallel(vae, device_ids=None) # device_ids=None
