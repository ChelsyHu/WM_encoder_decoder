...
def get_parser():
    ...
    aa("--workers", type=int, default=16, help="Number of workers for data loading. (Default: 8)")   ####
...
def main(params):
    ...
    if params.dist: 
        # print('CUDA:')
        # print("amount of gpus: ",torch.cuda.device_count())  # 打印gpu数量
        ...
        # torch.cuda.set_device(params.local_rank)  # 设置gpu编号为local_rank;此句也可能看出local_rank的值是什么
    ...
    lr_mult = params.batch_size * utils.get_world_size() / 512.0 *2
